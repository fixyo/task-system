...
<div id="task">
    <div class="indexBody">
        <div class="innerBody">
            ...
            <Modal id="taskModal" v-model="launchTaskModal" style="width: 920px;">
                 <p slot="header">
...
#taskModal .ivu-btn:hover {
    color: #19aa8d;
    background-color: #fff;
    border-color: #19aa8d;
}
#taskModal .ivu-btn:focus {
    box-shadow: none;
}
</style>
