...
<div class="cloudCooper">
    <div class="detailContent">
        ...
        <Row class="rowPadding">
            ...
            <Col span="5">
            <p class="top">{{addIncome.planerName}}合同</p>
            </Col>
            <Col span="3" class="title">合同类型：</Col>
            <Col span="5">
            <p class="top">{{addIncome.contractTypeName}}合同</p>
            </Col>
        </Row>
    </div>
    <!--甲方-->
    ...
    <div class="detailContent">
        ...
        <Row class="rowPadding">
            ...
            <Col span="5">
            <p class="top">{{addIncome.startTime}} ~ {{addIncome.endTime}}</p>
            </Col>
        </Row>
        <!--合同金额-->
        <Row class="rowPadding">
    ...
    <!-- <div class="detailContent">
        ...
        <Row class="rowPadding">
            ...
            <p class="top person">{{addIncome.copieruserName}}</p>
            </Col>
        </Row>
    </div> -->
    <!-- 拒绝原因 -->
    <div class="detailContent">
        ...
        <Row class="rowPadding">
            <Col span="5" offset="4">
                <div class="refuse">{{addIncome.rejectReason||'暂无'}}</div>
            </Col>
        </Row>
    </div>
    <!--操作按钮-->
