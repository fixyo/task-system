  ...
  <div class="cloudCooper">
    ...
    <div class="detailContent">
        ...
        <Row class="rowPadding">
            ...
            <i class="require">*</i>文件上传：
              ...
              <Col span="5">
                <p  v-for="(item,index) in addIncome.enclosure" :key="index"><a :href="item.enclosureUrl">{{item.enclosureName}}</a></p>
    ...
    <div class="detailContent">
      ...
      <Modal id="addNotice" :mask-closable="false" v-model="showNotice" title="抄送人">
        ...
        >
          <Option
            v-for="person in addIncome.incumbencyTbUser"
            :key="person.id"
            :value="person.id"
    ...
    getData () {
      ...
      this.$axios({
        ...
        if (res.data.code === 10000) {
          ...
          this.enclosure = res.data.content.enclosure
        } else {
          this.$Message.error(res.data.msg)
        }
      }).catch(err => {
