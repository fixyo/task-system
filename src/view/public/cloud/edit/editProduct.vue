            ...
            <TabPane label="产品公司" name="1">
                ...
                <div class="detailContent">
                    ...
                    <Row class="rowPadding" v-if="!person">
                        ...
                        <Col span="6">
                            <Select v-model="companyInfo.regionId" clearable filterable style="width:319px;margin-right: 5px;">
...
export default {
  ...
  methods: {
    ...
    // 产品公司选择
    choseCompanyType () {
      (this.companyInfo.companyType === 1) ? this.person = true : this.person = false
    ...
    saveNewPro () {
      ...
      this.$axios({
        url: baseUrl + '/productCompany/update',
        method: 'post',
        data: sendData
      }).then(res => {
        if (res.data.code === 10000) {
